...
export const PlaneIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.7 5.7c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z" />
    </svg>
);
...
export const RocketIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.33-.04-3.08.69-.13 1.38-.32 2.08-.58a15.2 15.2 0 0 0 5.2-3.55c.44-.44.82-.93 1.14-1.46.32-.53.58-1.1.78-1.7.2-.6.33-1.24.4-1.9.07-.65.1-1.33.04-2.02-.06-.69-.18-1.38-.34-2.05a21.4 21.4 0 0 0-1.54-4.43c-.44-.86-1-1.7-1.64-2.46l-.23-.28c-.23-.28-.48-.54-.74-.79a.5.5 0 0 0-.7.7c.25.24.48.49.7.75l.23.28c.63.75 1.18 1.58 1.6 2.42a20.4 20.4 0 0 1 1.48 4.25c.15.65.27 1.32.33 1.98.06.65.04 1.3-.04 1.94-.06.56-.2 1.1-.4 1.62-.22.53-.5 1.03-.88 1.47a14.2 14.2 0 0 1-4.94 3.33c-.7.26-1.4.45-2.1.58-.75.75-2.24.73-3.08-.04Z"/><path d="m12 15-3-3a.5.5 0 0 1 .7-.7l3 3a.5.5 0 0 1-.7.7Z"/></svg>
);

export const CheckCircleFilledIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-1.06 13.06a.75.75 0 001.06 0l5-5a.75.75 0 10-1.06-1.06L11.5 13.44l-2.97-2.97a.75.75 0 00-1.06 1.06l3.5 3.5z" clipRule="evenodd" />
    </svg>
);
...
export const QrCodeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <line x1="17.5" y1="21" x2="17.51" y2="21" />
